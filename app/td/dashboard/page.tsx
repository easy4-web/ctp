  ...
  return (
    <div className="min-h-screen" style={{ background: '#0f0f0f' }}>
      ...
      <main className="p-6 max-w-4xl mx-auto">
        <p className="text-xs text-gray-600 uppercase tracking-widest mb-6 font-medium">Tournaments</p>
        ...
        {!tournaments?.length ? (
          ...
          <div className="space-y-3">
            {tournaments.map((t: Tournament) => (
              <div key={t.id} className="rounded-2xl p-5 border flex items-center justify-between" style={{ background: '#191919', borderColor: '#2a2a2a' }}>
                <div>
                  <div className="flex items-center gap-3">
                    <span className="font-semibold">{t.name}</span>
                    <span className="text-xs px-2.5 py-0.5 rounded-full font-medium" style={t.active
